...
### GVC genes filtered and sorted by Agora's `genetics_score`
...
### GVC genes filtered and sorted by OpenTargets' `otGeneticsPortal`
...
### GVC genes filtered and sorted by Agora's `target_risk_score`
...
### GVC genes filtered and sorted by OpenTargets' `globalScore`
